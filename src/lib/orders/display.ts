...
const STATUS_LABELS: Record<string, string> = {
  ...
  [ORDER_STATUS.RETURN_DECLINED]: "Return declined",
...
const STATUS_BADGE: Record<string, string> = {
  ...
  [ORDER_STATUS.RETURN_REQUESTED]: "bg-amber-100 text-amber-950",
  [ORDER_STATUS.RETURN_APPROVED]: "bg-sky-100 text-sky-950",
  [ORDER_STATUS.RETURN_DECLINED]: "bg-stone-200 text-stone-800",
  [ORDER_STATUS.RETURNED]: "bg-cyan-100 text-cyan-950",
